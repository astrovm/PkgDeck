...
| --- | --- |
| AppImage | Download `PkgDeck-v0.1.2-x86_64.AppImage` or `PkgDeck-v0.1.2-aarch64.AppImage`. For x86_64, run `chmod +x PkgDeck-v0.1.2-x86_64.AppImage` and then `./PkgDeck-v0.1.2-x86_64.AppImage`. |
| Snap | Download `PkgDeck-v0.1.2-x86_64.snap` or `PkgDeck-v0.1.2-aarch64.snap`. For x86_64, run `sudo snap install --dangerous --classic ./PkgDeck-v0.1.2-x86_64.snap`. The Snap is hosted on GitHub, not the Snap Store. |
...
`./PkgDeck-v0.1.2-x86_64.AppImage --cli` in AppImage (substitute your architecture).
