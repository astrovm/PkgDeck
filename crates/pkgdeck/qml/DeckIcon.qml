...
Item {
    ...
    readonly property var drawings: ({
        ...
        "npm": [[2,7,22,7,22,17,2,17,2,7], [7,14,7,10,11,10,11,14], [13,14,13,10,17,10,17,14]],
        "pnpm": [[2,7,22,7,22,17,2,17,2,7], [8,19,8,10,16,10,16,14,8,14]],
    ...
    readonly property var arcs: ({
        ...
        "spinner": "M 12 3 A 9 9 0 1 1 3 12",
